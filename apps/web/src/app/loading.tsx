    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-cream-100/80 backdrop-blur-sm">
      <div className="flex flex-col items-center gap-6">
        <div className="relative">
          <div
            className="h-16 w-16 animate-spin rounded-full border-4 border-charcoal-200"
            style={{ borderTopColor: "#C75B39" }}
          />
        ...
        <div className="text-center">
          <p className="text-lg font-serif font-semibold text-charcoal-800">
            Loopingon
          </p>
        ...
        <div className="flex gap-1">
          {[0, 1, 2].map((i) => (
            <div
              key={i}
              className="h-2 w-2 animate-bounce rounded-full bg-terracotta-400"
              style={{
