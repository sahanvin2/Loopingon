  ...
  return (
    <article className="bg-white">
      ...
      <div className="mx-auto max-w-3xl px-4 py-12">
        <Link href="/blog" className="mb-6 inline-flex items-center gap-1 text-sm font-medium text-terracotta-600 hover:text-terracotta-700">
        ...
        <h1 className="font-serif text-3xl font-bold text-charcoal-900 md:text-4xl">{post.title}</h1>

        <div className="mt-4 flex flex-wrap items-center gap-4 text-sm text-warm-gray-600">
          {post.publishedAt && <span>{formatDate(post.publishedAt)}</span>}
          {post.category && (
            <>
              <span>·</span>
              <span className="rounded-full bg-terracotta-50 px-3 py-0.5 text-xs font-medium text-terracotta-600">{post.category}</span>
            </>
          )}
          <span>·</span>
        ...
        <div className="mt-10 prose-headings:font-serif prose-a:text-terracotta-600 prose-p:leading-relaxed prose-img:rounded-xl max-w-none text-warm-gray-700 [&_h2]:text-2xl [&_h2]:font-bold [&_h2]:text-charcoal-900 [&_h3]:text-xl [&_h3]:font-semibold [&_h3]:text-charcoal-800 [&_p]:text-base [&_p]:leading-7 [&_a]:underline [&_blockquote]:border-l-4 [&_blockquote]:border-gold-400 [&_blockquote]:bg-cream-50 [&_blockquote]:py-4 [&_blockquote]:pl-6 [&_blockquote]:italic [&_blockquote]:text-warm-gray-600 [&_img]:my-6 [&_ul]:list-disc [&_ul]:pl-6 [&_ol]:list-decimal [&_ol]:pl-6"
        ...
        <div className="mt-10 border-t border-charcoal-200 pt-6">
          <div className="flex items-center justify-between">
            ...
            <Link href="/blog" className="text-sm font-medium text-terracotta-600 hover:underline">
              ← Back to all posts
            </Link>
          </div>
        </div>
