...
export const metadata: Metadata = {
  ...
  description: "Kandyam Intellectual Property Policy: Copyright ownership, trademark guidelines, reporting infringement, DMCA process, and user-generated content licensing.",
};
  ...
  return (
    <div className="bg-surface-50 py-16">
      <div className="mx-auto max-w-3xl px-4">
        <h1 className="font-serif text-4xl font-bold text-text-900">Intellectual Property Policy</h1>
        ...
        <div className="mt-10 space-y-8 text-sm leading-relaxed text-muted-700 [&_h2]:font-serif [&_h2]:text-xl [&_h2]:font-bold [&_h2]:text-text-900 [&_h3]:font-semibold [&_h3]:text-text-800 [&_p]:mt-3 [&_ul]:mt-3 [&_ul]:list-disc [&_ul]:pl-6">
          <section>
            ...
            <p>Kandyam respects the intellectual property rights of others and expects our users to do the same. We are committed to protecting the creative works of artisans, designers, and content creators on our platform.</p>
          </section>

          <section>
            <h2>Copyright Ownership</h2>
            <p>Vendors retain full copyright ownership of their product photos, product descriptions, store branding elements, and any original content they upload to the Platform. Kandyam does not claim ownership of vendor content.</p>
            <p>By listing products on Kandyam, vendors grant us a non-exclusive, worldwide, royalty-free license to display, distribute, and promote their product listings on the Platform and in associated marketing materials (social media, email campaigns, advertisements). This license ends when the content is removed from the Platform.</p>
          </section>

          <section>
            <h2>Trademark Guidelines</h2>
            <ul>
              <li>The name &quot;Kandyam&quot; and the Kandyam logo are registered trademarks of Kandyam (Pvt) Ltd.</li>
          ...
          <section>
            ...
            <p>If you believe your copyright or trademark has been infringed by content on Kandyam, please send a notice to ip@kandyam.com with:</p>
            <ul>
              <li>Your full name and contact information</li>
              <li>Identification of the copyrighted or trademarked work</li>
              <li>The URL of the infringing content on Kandyam</li>
          ...
          <section>
            ...
            <p>When you post reviews, comments, photos, or other content on Kandyam, you retain ownership but grant us and other users a non-exclusive license to view and interact with that content on the Platform. You are responsible for ensuring your content does not infringe on others&apos; rights.</p>
          </section>
