  ...
  return (
    <div className="bg-cream-100 py-16">
      <div className="mx-auto max-w-3xl px-4">
        ...
        <div className="mt-8 rounded-xl bg-cream-50 border border-gold-200 p-6">
          <h2 className="text-sm font-semibold text-gold-800 uppercase tracking-wide">Plain Language Summary</h2>
          <ul className="mt-3 space-y-2 text-sm text-warm-gray-700">
        ...
        <div className="mt-10 space-y-8 text-sm leading-relaxed text-warm-gray-700 [&_h2]:font-serif [&_h2]:text-xl [&_h2]:font-bold [&_h2]:text-charcoal-900 [&_h2]:mt-8 [&_h3]:font-semibold [&_h3]:text-charcoal-800 [&_h3]:mt-6 [&_p]:mt-3 [&_ul]:mt-3 [&_ul]:list-disc [&_ul]:pl-6 [&_li]:mt-1">
          <section>
          ...
          <section>
            ...
            <p>We use essential cookies to keep you logged in and remember your cart. We also use analytics cookies (Google Analytics) and marketing pixels (Facebook Pixel) with your consent. See our <a href="/cookie-policy" className="text-terracotta-600 hover:underline">Cookie Policy</a> for details.</p>
          </section>
