      ...
      <div className="mx-auto max-w-3xl px-4">
        ...
        <div className="mt-10 space-y-8 text-sm leading-relaxed text-warm-gray-700 [&_h2]:font-serif [&_h2]:text-xl [&_h2]:font-bold [&_h2]:text-charcoal-900 [&_h3]:font-semibold [&_h3]:text-charcoal-800 [&_p]:mt-3 [&_ul]:mt-3 [&_ul]:list-disc [&_ul]:pl-6 [&_table]:w-full [&_table]:mt-4 [&_th]:border [&_th]:border-charcoal-200 [&_th]:px-4 [&_th]:py-2 [&_th]:bg-cream-50 [&_th]:text-left [&_td]:border [&_td]:border-charcoal-200 [&_td]:px-4 [&_td]:py-2">
          ...
          <section>
            ...
            <p>We use Google Analytics to understand how visitors interact with our website. Google Analytics uses cookies to collect anonymous usage data. You can opt out at <a href="https://tools.google.com/dlpage/gaoptout" className="text-terracotta-600 hover:underline" target="_blank" rel="noopener noreferrer">tools.google.com/dlpage/gaoptout</a>.</p>
          ...
          <section>
            ...
            <p className="mt-3 rounded-lg bg-gold-50 border border-gold-200 p-4"><strong>Note:</strong> Blocking all cookies may prevent some features from working correctly, including the shopping cart, checkout, and account login.</p>
          </section>
