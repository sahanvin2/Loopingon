      ...
      >
        <div className="rounded-3xl bg-white/80 backdrop-blur-xl p-8 md:p-10 shadow-[0_20px_60px_-20px_rgba(176,86,110,0.3)] border border-white/50">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={cn(
                    "w-full rounded-xl border py-3.5 pl-12 pr-4 text-sm text-text-900",
                    "placeholder:text-muted-400 bg-white/80",
                    "focus:border-primary-400 focus:ring-4 focus:ring-primary-400/10 focus:outline-none transition-all",
                    errors.email ? "border-red-400 focus:ring-red-400/10" : "border-accent-200"
                  )}
                />
              </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={cn(
                    "w-full rounded-xl border py-3.5 pl-12 pr-12 text-sm text-text-900",
                    "placeholder:text-muted-400 bg-white/80",
                    "focus:border-primary-400 focus:ring-4 focus:ring-primary-400/10 focus:outline-none transition-all",
                    errors.password ? "border-red-400 focus:ring-red-400/10" : "border-accent-200"
                  )}
                />
                <button type="button" onClick={() => setShowPassword(!showPassword)} className="absolute right-4 top-1/2 -translate-y-1/2 text-muted-400 hover:text-text-600 transition-colors">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2.5 cursor-pointer group">
                <input type="checkbox" {...register("rememberMe")} className="h-4 w-4 rounded border-text-300 text-primary-500 focus:ring-primary-400" />
                <span className="text-sm text-muted-600 group-hover:text-text-700 transition-colors">Remember me</span>
              </label>
          ...
          <p className="mt-8 text-center text-sm text-muted-500">
            ...
            <Link href="/sign-up/customer" className="font-semibold text-primary-500 hover:text-primary-600 transition-colors">
              Create one
            </Link>
          </p>
