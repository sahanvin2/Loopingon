      ...
      >
        <div className="rounded-3xl bg-white/80 backdrop-blur-xl p-8 md:p-10 shadow-[0_20px_60px_-20px_rgba(176,86,110,0.3)] border border-white/50">
          <div className="mb-8 text-center">
            <Link href="/" className="inline-flex items-center justify-center h-12 w-12 rounded-full bg-gradient-to-br from-primary-400 to-primary-600 text-white font-serif text-xl shadow-[0_8px_24px_-8px_rgba(176,86,110,0.6)] hover:scale-105 transition-transform mb-4">
              L
            </Link>
          ...
          <div className="mt-5 grid grid-cols-2 gap-3">
            <button className="flex h-12 items-center justify-center gap-2.5 rounded-xl border border-accent-200 bg-white text-sm font-medium text-text-700 transition-all hover:bg-accent-50 hover:border-accent-300 hover:shadow-sm">
