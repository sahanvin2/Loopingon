      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 max-w-lg">
        <div className="bg-white rounded-xl border border-blush-200 p-6 space-y-4">
          ...
          <div>
            ...
            <input {...register("platformName")} className="w-full px-3 py-2 border border-blush-200 rounded-lg text-sm focus:ring-2 focus:ring-rose-500" />
          </div>
          <div>
            <label className="block text-sm font-medium mb-1">Default Commission Rate (%)</label>
            <input type="number" step="0.1" {...register("defaultCommissionRate")} className="w-full px-3 py-2 border border-blush-200 rounded-lg text-sm focus:ring-2 focus:ring-rose-500" />
          </div>
          <div>
            <label className="block text-sm font-medium mb-1">Payout Schedule</label>
            <select {...register("payoutSchedule")} className="w-full px-3 py-2 border border-blush-200 rounded-lg text-sm">
        ...
        <div className="bg-white rounded-xl border border-blush-200 p-6 space-y-4">
          ...
          <div>
            ...
            <input className="w-full px-3 py-2 border border-blush-200 rounded-lg text-sm" />
          </div>
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="block text-sm font-medium mb-1">Port</label>
              <input type="number" className="w-full px-3 py-2 border border-blush-200 rounded-lg text-sm" />
            </div>
            <div>
          ...
          <div>
            ...
            <input type="password" className="w-full px-3 py-2 border border-blush-200 rounded-lg text-sm" />
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl border border-blush-200 p-6 space-y-4">
          ...
          <div>
            ...
            <input type="password" className="w-full px-3 py-2 border border-blush-200 rounded-lg text-sm font-mono" />
          </div>
          <div>
        ...
        <button type="submit" disabled={isSubmitting} className="inline-flex items-center gap-2 px-6 py-3 bg-rose-600 text-white rounded-lg font-medium hover:bg-rose-700 disabled:opacity-50">
