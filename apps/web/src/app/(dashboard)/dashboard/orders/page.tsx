      ...
      <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center">
        ...
        <div className="relative flex-1 max-w-xs">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 border border-cream-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-terracotta-500 focus:border-transparent"
          />
        </div>
      </div>
      ...
      {isLoading ? (
        ...
        <div className="space-y-3">
          {orders.map((order) => (
            <div
              key={order.id}
              className="bg-white rounded-lg border border-cream-200 p-4 hover:shadow-soft transition-shadow"
            >
              ...
              {order.items && (
                <div className="flex items-center gap-2 mt-3">
                  {order.items.slice(0, 3).map((item, i) => (
                    <div
                      key={item.id}
                      className="w-10 h-10 rounded-md border border-cream-200 overflow-hidden bg-cream-50"
                    ...
                    >
                      {item.productImage ? (
                        ...
                        <div className="w-full h-full flex items-center justify-center text-warm-gray-400 text-xs">
              ...
              <div className="flex items-center justify-between mt-3">
                ...
                <Link
                  ...
                  className="flex items-center gap-1 text-sm font-medium text-terracotta-600 hover:text-terracotta-700 transition-colors"
                >
                  View Details
