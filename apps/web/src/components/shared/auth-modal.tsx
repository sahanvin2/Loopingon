  ...
  return (
    <div>
      ...
      <div className="mt-4 grid grid-cols-2 gap-3">
        <button onClick={handleGoogleSignIn} type="button" className="flex h-11 items-center justify-center gap-2 rounded-xl border border-accent-200 bg-white text-sm font-medium text-text-700 transition-colors hover:bg-accent-50">
        ...
        <button onClick={handleFacebookSignIn} type="button" className="flex h-11 items-center justify-center gap-2 rounded-xl bg-[#1877F2] text-sm font-medium text-white transition-colors hover:bg-[#166FE5]">
