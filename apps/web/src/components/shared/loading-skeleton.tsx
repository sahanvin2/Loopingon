...
function ProductCardSkeleton() {
  return (
    <div className="rounded-lg bg-white border border-blush-300 overflow-hidden shadow-sm">
...
function ListSkeleton() {
  return (
    <div className="flex items-center gap-4 p-4 border border-blush-300 rounded-lg bg-white">
...
function TableRowSkeleton() {
  return (
    <div className="flex items-center gap-4 p-4 border-b border-blush-200">
...
const variantMap: Record<SkeletonVariant, () => React.ReactElement> = {
  card: () => (
    <div className="rounded-lg bg-white border border-blush-300 p-6 shadow-sm space-y-4">
