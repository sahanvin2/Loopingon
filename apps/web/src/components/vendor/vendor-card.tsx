...
export function VendorCard({ vendor, className }: VendorCardProps) {
  return (
    <motion.div
      ...
      className={cn(
        "bg-white rounded-lg border border-cream-300 shadow-sm overflow-hidden",
    ...
    >
      ...
      >
        <div className="w-20 h-20 mx-auto rounded-full border-2 border-cream-200 overflow-hidden bg-warm-gray-100 mb-4">
          {vendor.storeLogo ? (
            <Image
        ...
        <div className="flex items-center justify-center gap-1 text-xs text-warm-gray-500 mb-3">
        ...
        <div className="flex items-center justify-center gap-4 text-sm mb-4">
          <div className="flex items-center gap-1">
            ...
            <span className="text-warm-gray-500">({vendor.reviewCount})</span>
          </div>
          <div className="flex items-center gap-1 text-warm-gray-500">
            <Package className="w-3.5 h-3.5" />
            {vendor.totalProducts}
          </div>
        </div>

        <p className="text-sm text-warm-gray-600 line-clamp-1 mb-4">
