        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="relative rounded-2xl overflow-hidden bg-[#F2EAE1] h-[220px] flex items-center shadow-sm group cursor-pointer">
            <div className="absolute right-0 top-0 bottom-0 w-1/2">
              <Image 
                src="https://images.unsplash.com/photo-1555680202-c86f0e12f086?w=400&h=300&fit=crop" 
                alt="Custom Software" 
            ...
            <div className="relative z-10 pl-8 pr-4 py-6 w-2/3">
              <h3 className="font-serif text-2xl font-bold text-navy-900 leading-tight">Custom software just for you</h3>
              <p className="text-sm font-medium text-text-700 mt-2 line-clamp-2">Bring your app ideas to life with our top developers.</p>
              <Link 
                href="/custom-orders" 
          ...
          <div className="relative rounded-2xl overflow-hidden bg-[#E2F0F1] h-[220px] flex items-center shadow-sm group cursor-pointer">
            <div className="absolute right-0 top-0 bottom-0 w-1/2">
              <Image 
                src="https://images.unsplash.com/photo-1614680376593-902f74cf0d41?w=400&h=300&fit=crop" 
                alt="Digital Gifts" 
                fill sizes="(max-width: 768px) 100vw, 50vw" 
                className="object-cover group-hover:scale-105 transition-transform duration-700" 
              />
            ...
            <div className="relative z-10 pl-8 pr-4 py-6 w-2/3">
              <h3 className="font-serif text-2xl font-bold text-navy-900 leading-tight">Gift cards for everyone</h3>
              <p className="text-sm font-medium text-text-700 mt-2 line-clamp-2">Steam, PlayStation, Xbox, and more!</p>
              <Link 
                href="/gift-ideas" 
