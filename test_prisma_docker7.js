...
const prisma = new PrismaClient({ log: ['query', 'info', 'warn', 'error'], datasourceUrl: 'postgresql://postgres:%4020040301Sahan@aws-0-ap-southeast-1.pooler.supabase.com:6543/postgres?pgbouncer=true&connection_limit=1' });
async function test() {
  try {
